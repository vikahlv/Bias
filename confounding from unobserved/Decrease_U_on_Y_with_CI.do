...
tempname memhold
postfile `memhold' mean_crude_or_X mean_z1_or_x mean_truth_or_X mean_z0_or_x z_y_effect mean_crude_bias mean_z1_bias mean_z_cond_or using "/newhome/pq19710/Indication_simulations/Do-file_output/Sim_Results_weak_u_with_CI.dta" , replace
forvalues i = 1(.01)10 {
